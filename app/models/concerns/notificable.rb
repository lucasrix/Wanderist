module Notificable
  ...
  OWNER_NOTIFICATIONS = %i(new_following new_like new_follower).freeze
  FOLLOWER_NOTIFICATIONS = %i(new_following new_story new_story_point new_story_point_in_story).freeze
